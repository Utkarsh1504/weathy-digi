...
function DetailsCard({ stats }) {
  return (
    <div className="bg-zinc-600 p-2 text-zinc-200 flex flex-col justify-start rounded-lg items-center hover:scale-105 transition transform">
